...
<style>
/* Enhanced Change Password Page Styles */
...
<div class="change-password-wrapper">
    ...
    <?php if(isset($_GET['pwd_error'])): ?>
        <div class="alert alert-danger">
            <span>⚠️</span>
            <span><?php echo htmlspecialchars($_GET['pwd_error']); ?></span>
        </div>
    <?php endif; ?>
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form action="profile_process.php" method="post" id="changePasswordForm">
            ...
            <div class="form-actions">
                <button type="submit" name="update_password" class="btn btn-primary" id="submitBtn">
                    <span>🔒</span>
