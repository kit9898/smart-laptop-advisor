...
<body>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-outline-danger" 
                                                                        onclick="deleteAdmin(<?php echo $admin['admin_id']; ?>, this)"
                                                                        title="Delete">
    ...
    <div class="modal fade" id="editAdminModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="editAdminForm" method="POST" action="ajax/edit_admin.php">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                <h6 class="border-bottom pb-2 mb-3">Change Password <small class="text-muted fw-normal">(Leave blank to keep current)</small></h6>
                            </div>
    ...
    <script>
        // NOTE: View functionality is currently just a placeholder/alert in the original code. 
        // We can either implement a read-only modal or essentially do what Edit does but with disabled fields.
        // For now, I'll direct View to Edit for simplicity or keep it basic.
        function viewAdmin(adminId) {
           editAdmin(adminId); // Re-use edit modal for now
        }
            ...
            fetch(`ajax/get_admin.php?id=${adminId}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.querySelector('#editAdminForm input[name="password"]').value = '';
                        document.querySelector('#editAdminForm input[name="confirm_password"]').value = '';
        ...
        function deleteAdmin(adminId, btn) {
        ...
        document.getElementById('editAdminForm')?.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    alert('Administrator settings updated successfully!');
                    location.reload();
                } else {
                    alert('Error: ' + data.message);
                }
